    ...
    -->
        ...
        <div class="main-panel">
            ...
            <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="title">BUILD CONFERENCE - AUGUST 2017</h4>
                                    <p class="category">
                ...
                <div class="container-fluid" id="allmembrs" style="display:none;">
                <div class="row">
                ...
                <div class="container-fluid" id="tifuser" style="display:none;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Register Member Here</h4>
                                </div>
                                <div class="card-content">
                                <form class="save-member" method="post" action="savemember" id="save-member">
							    {{csrf_field()}}
                                        <div class="row">
                                            <div class="col-md-3">
                                        ...
                                        <button type="submit" id="savemember" class="btn btn-primary pull-right">Save</button>
...
$(document).ready(function(){
  ...
  function removeError(){
   ...
   $('#savemember').on('click',function(e){
    e.preventDefault();
           var savemember = $('.save-member').serializeArray();
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ["Tanzania", "Kenya", "Uganda", "Rwanda", "Burundi"],
        datasets: [{
            label: 'Males',
